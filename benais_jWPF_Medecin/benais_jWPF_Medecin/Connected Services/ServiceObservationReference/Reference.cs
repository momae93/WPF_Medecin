...
namespace benais_jWPF_Medecin.ServiceObservationReference {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceObservationReference.IServiceObservation")]
    public interface IServiceObservation {
        ...
        bool AddObservation(int idPatient, benais_jWPF_Medecin.ServiceObservationReference.Observation obs);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceObservation/AddObservation", ReplyAction="http://tempuri.org/IServiceObservation/AddObservationResponse")]
        System.Threading.Tasks.Task<bool> AddObservationAsync(int idPatient, benais_jWPF_Medecin.ServiceObservationReference.Observation obs);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceObservationChannel : benais_jWPF_Medecin.ServiceObservationReference.IServiceObservation, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceObservationClient : System.ServiceModel.ClientBase<benais_jWPF_Medecin.ServiceObservationReference.IServiceObservation>, benais_jWPF_Medecin.ServiceObservationReference.IServiceObservation {
        ...
        public bool AddObservation(int idPatient, benais_jWPF_Medecin.ServiceObservationReference.Observation obs) {
            return base.Channel.AddObservation(idPatient, obs);
        }
        
        public System.Threading.Tasks.Task<bool> AddObservationAsync(int idPatient, benais_jWPF_Medecin.ServiceObservationReference.Observation obs) {
