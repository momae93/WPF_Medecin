...
namespace benais_jWPF_Medecin.ServicePatientReference {
    ...
    public partial class Patient : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private benais_jWPF_Medecin.ServicePatientReference.Observation[] ObservationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public benais_jWPF_Medecin.ServicePatientReference.Observation[] Observations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServicePatientReference.IServicePatient")]
    public interface IServicePatient {
        ...
        benais_jWPF_Medecin.ServicePatientReference.Patient[] GetListPatient();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetListPatient", ReplyAction="http://tempuri.org/IServicePatient/GetListPatientResponse")]
        System.Threading.Tasks.Task<benais_jWPF_Medecin.ServicePatientReference.Patient[]> GetListPatientAsync();
        ...
        benais_jWPF_Medecin.ServicePatientReference.Patient GetPatient(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/GetPatient", ReplyAction="http://tempuri.org/IServicePatient/GetPatientResponse")]
        System.Threading.Tasks.Task<benais_jWPF_Medecin.ServicePatientReference.Patient> GetPatientAsync(int id);
        ...
        bool AddPatient(benais_jWPF_Medecin.ServicePatientReference.Patient user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePatient/AddPatient", ReplyAction="http://tempuri.org/IServicePatient/AddPatientResponse")]
        System.Threading.Tasks.Task<bool> AddPatientAsync(benais_jWPF_Medecin.ServicePatientReference.Patient user);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicePatientChannel : benais_jWPF_Medecin.ServicePatientReference.IServicePatient, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicePatientClient : System.ServiceModel.ClientBase<benais_jWPF_Medecin.ServicePatientReference.IServicePatient>, benais_jWPF_Medecin.ServicePatientReference.IServicePatient {
        ...
        public benais_jWPF_Medecin.ServicePatientReference.Patient[] GetListPatient() {
            return base.Channel.GetListPatient();
        }
        
        public System.Threading.Tasks.Task<benais_jWPF_Medecin.ServicePatientReference.Patient[]> GetListPatientAsync() {
            return base.Channel.GetListPatientAsync();
        }
        
        public benais_jWPF_Medecin.ServicePatientReference.Patient GetPatient(int id) {
            return base.Channel.GetPatient(id);
        }
        
        public System.Threading.Tasks.Task<benais_jWPF_Medecin.ServicePatientReference.Patient> GetPatientAsync(int id) {
